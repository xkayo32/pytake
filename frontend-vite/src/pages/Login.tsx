        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          <div className="flex gap-2 text-xs">
            <div className="flex-1 bg-gray-50 p-2 rounded">
              ...
              <p className="font-mono text-gray-600">admin@pytake.com</p>
              <p className="font-mono text-gray-600">Admin123</p>
            </div>
            <div className="flex-1 bg-gray-50 p-2 rounded">
              <p className="font-semibold text-gray-700">Agente</p>
              <p className="font-mono text-gray-600">agente@pytake.com</p>
              <p className="font-mono text-gray-600">Agente123</p>
            </div>
          </div>
        </div>
      </div>
