...
export default function ChatbotBuilderPage() {
  ...
  const loadFlowCanvas = (flow: Flow) => {
    if (flow.canvas_data?.nodes && flow.canvas_data?.edges) {
      ...
      nodeIdCounter = flow.canvas_data.nodes.length;
    } else {
      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex items-center justify-between shadow-sm z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title={`${showSidebar ? 'Ocultar' : 'Mostrar'} Sidebar (Ctrl+B)`}
          >
          ...
          <button
            ...
            title={`${showProperties ? 'Ocultar' : 'Mostrar'} Propriedades (Ctrl+P)`}
          >
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
            {isSaving ? (
              <>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                  <div className="flex justify-between">
                    <span>Salvar</span>
                    <code className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Ctrl+S</code>
                  </div>
                  <div className="flex justify-between">
                    <span>Deletar</span>
                    <code className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Del</code>
                  </div>
                  <div className="flex justify-between">
                    <span>Sidebar</span>
                    <code className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Ctrl+B</code>
                  </div>
                  <div className="flex justify-between">
                    <span>Propriedades</span>
                    <code className="px-1.5 py-0.5 bg-gray-200 dark:bg-gray-700 rounded">Ctrl+P</code>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            {selectedNode && (
              <Panel position="top-center">
                <div className="bg-white dark:bg-gray-800 px-3 py-2 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 flex items-center gap-2">
            ...
            <Panel position="bottom-left">
              <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
                <p className="text-xs text-gray-600 dark:text-gray-400 flex items-center gap-2">
                  <span className="font-semibold">{nodes.length}</span> nós
                  <span className="text-gray-400">•</span>
                  <span className="font-semibold">{edges.length}</span> conexões
                </p>
              </div>
            </Panel>
          </ReactFlow>
